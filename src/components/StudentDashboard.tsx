      ...
      <main className="flex-1 overflow-y-auto scroll-smooth flex flex-col justify-between h-screen">
        ...
        <div className="p-8 max-w-[1280px] w-full mx-auto space-y-8 flex-1 pb-12">
            ...
            <div className="space-y-8 animate-fadeIn">
              <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 flex flex-col justify-center">
                  <h2 className="text-3xl font-black tracking-tight text-[#0b1c30] mb-1">Welcome back, Anuj</h2>
                  <p className="text-base text-[#464555] max-w-xl">You&apos;re making great progress. You&apos;ve completed 82% of your &quot;Advanced UX Architecture&quot; track this week.</p>
                </div>
                <StreakCard />
              </section>
          ...
          {activeTab === "courses" && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {ALL_COURSES_DATA.map((course: CourseItem, idx: number) => (
                  <CourseGridCard key={idx} {...course} />
                ))}
              </div>
            </div>
          )}
          ...
          {activeTab === "resources" && (
            <div className="space-y-6 animate-fadeIn">
              <div>
                <h2 className="text-2xl font-black text-[#0b1c30]">Downloadable Resources</h2>
                <p className="text-sm text-[#464555]">Access books, files, and asset packs immediately.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {RESOURCES_DATA.map((resource: ResourceItem, idx: number) => (
          ...
          {activeTab === "certificates" && (
            <div className="space-y-6 animate-fadeIn">
              <div>
                <h2 className="text-2xl font-black text-[#0b1c30]">Verified Certificates</h2>
                <p className="text-sm text-[#464555]">Your secured, completed credential matrix nodes.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

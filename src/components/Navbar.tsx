...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-50 flex justify-between items-center w-full px-4 sm:px-6 md:px-12 h-16 bg-[#f8f9ff]/80 backdrop-blur-xl border-b border-[#c7c4d8]/10 shadow-sm relative">
      ...
      <nav className="hidden lg:flex items-center gap-6 text-[#464555] font-medium text-sm">
        <button
          onClick={() => setCurrentScreen("home")}
          className={`transition cursor-pointer ${
            currentScreen === "home" ? "text-[#3525cd] font-bold" : "hover:text-[#3525cd]"
          }`}
        >
          Home
        </button>
        <button
          ...
          className={`transition cursor-pointer ${
            currentScreen === "courses" ? "text-[#3525cd] font-bold" : "hover:text-[#3525cd]"
          }`}
        >
          Courses
        </button>
        <button
          ...
          className={`transition cursor-pointer ${
            currentScreen === "mentors" ? "text-[#3525cd] font-bold" : "hover:text-[#3525cd]"
          }`}
        >
          Mentors
        </button>
        <button
          ...
          className={`transition cursor-pointer ${
            currentScreen === "pricing" ? "text-[#3525cd] font-bold" : "hover:text-[#3525cd]"
          }`}
        >
          Pricing
        </button>
        <button
          ...
          className={`transition cursor-pointer ${
            currentScreen === "community" ? "text-[#3525cd] font-bold" : "hover:text-[#3525cd]"
          }`}
        >
          Community
        </button>
      ...
      {/* Responsive Hamburger Mobile Button */}
      <button
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-16 left-0 w-full bg-white border-b border-[#c7c4d8]/20 shadow-lg px-6 py-4 flex flex-col gap-4 z-40 animate-fadeIn">
          <button
            ...
            className={`text-left py-2 text-sm font-medium transition cursor-pointer ${
              currentScreen === "home" ? "text-[#3525cd] font-bold" : "text-[#464555]"
            }`}
          >
            Home
          </button>
          <button
            ...
            className={`text-left py-2 text-sm font-medium transition cursor-pointer ${
              currentScreen === "courses" ? "text-[#3525cd] font-bold" : "text-[#464555]"
            }`}
          >
            Courses
          </button>
          <button
            ...
            className={`text-left py-2 text-sm font-medium transition cursor-pointer ${
              currentScreen === "mentors" ? "text-[#3525cd] font-bold" : "text-[#464555]"
            }`}
          >
            Mentors
          </button>
          <button
            ...
            className={`text-left py-2 text-sm font-medium transition cursor-pointer ${
              currentScreen === "pricing" ? "text-[#3525cd] font-bold" : "text-[#464555]"
            }`}
          >
            Pricing
          </button>
          <button
            ...
            className={`text-left py-2 text-sm font-medium transition cursor-pointer ${
              currentScreen === "community" ? "text-[#3525cd] font-bold" : "text-[#464555]"
            }`}
          >
            Community
          </button>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full text-center py-2 text-sm font-medium text-[#464555] hover:text-[#3525cd] transition cursor-pointer"
            >
              Sign In
            </button>
            <button
              ...
              className="w-full text-center bg-[#4f46e5] text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-[#3525cd] transition shadow-md shadow-[#4f46e5]/20 cursor-pointer"
            >
              Get Started
            </button>
          </div>

            ...
            >
                <div className="text-slate-100 font-sans selection:bg-[#8b5cf6]/20 min-h-screen antialiased flex flex-col justify-between w-full relative bg-[#070710]">
                    ...
                    <main className="flex-grow">
                        ...
                        <div className={currentScreen === "home" ? "animate-fadeIn" : "hidden"}>
                            ...
                            <section className="relative overflow-hidden w-full h-[80vh] flex items-center justify-center px-6 md:px-12 bg-transparent border-b border-white/5">
                                ...
                                <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                                    <video
                                        ...
                                        className="w-full h-full object-cover scale-[1.15] transform origin-center"
                                    >
                                ...
                                <div className="relative z-10 mt-6 pt-4 space-y-6 text-center flex flex-col items-center justify-center w-full max-w-4xl mx-auto drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
                                    <div className="inline-flex items-center gap-2 bg-[#8b5cf6]/20 border border-[#8b5cf6]/40 text-purple-200 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm backdrop-blur-md">
                                        <span className="material-symbols-outlined text-sm select-none">auto_awesome</span>
                                        THE NEXT-GEN KNOWLEDGE PIPELINE
                                    </div>
                                    <h1 className="text-4xl sm:text-5xl lg:text-[58px] font-black tracking-tight leading-[1.08] text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-2 w-full">
                                        <button
                                            ...
                                            className="w-full sm:w-auto bg-[#f97316] hover:bg-[#ea580c] text-white px-8 py-4 rounded-xl font-extrabold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-orange-500/20 hover:shadow-orange-500/45 hover:-translate-y-0.5"
                                        >
                                            Start Learning Free
                                        ...
                                        <button
                                            ...
                                            className="bg-black/40 text-white border border-[#8b5cf6] hover:border-[#f97316] hover:bg-[#8b5cf6]/10 px-8 py-4 rounded-xl font-extrabold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-sm hover:shadow-md hover:-translate-y-0.5 backdrop-blur-md"
                                        >
                            ...
                            <section className="relative z-20 py-16 px-6 md:px-16 max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch justify-center">
                                <div className="h-full bg-[#0d0c22]/90 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-2xl flex flex-col space-y-5 hover:shadow-purple-500/10 hover:border-purple-500/30 transition-all duration-300 text-white">
                                ...
                                <div className="h-full bg-[#0d0c22]/90 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-2xl flex flex-col space-y-5 hover:shadow-orange-500/10 hover:border-orange-500/30 transition-all duration-300 text-white">
                                    ...
                                    <div className="lg:col-span-7 space-y-4">
                                        <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-900 border border-white/10 shadow-xl">
                                            ...
                                            <div className="absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/60 backdrop-blur-md text-white rounded-xl px-5 py-3 flex items-center gap-3 border border-white/10 shadow-lg">
                                                <span className="material-symbols-outlined text-2xl text-[#f97316] animate-pulse select-none">{CHAPTERS_DATA[activeChapter].icon}</span>
                                                <div className="text-left">
                                        ...
                                        {CHAPTERS_DATA.map((chapter, idx) => (
                                            <button
                                                ...
                                                className={`w-full text-left p-4 rounded-xl transition border flex gap-4 items-center cursor-pointer ${activeChapter === idx
                                                    ? "bg-white/10 border-[#f97316]/50 shadow-sm"
                                                    : "bg-white/5 border-transparent hover:bg-white/10"
                                                    }`}
                                            >
                                                <div className={`w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs ${activeChapter === idx ? "bg-gradient-to-r from-[#8b5cf6] to-[#f97316] text-white" : "bg-white/10 text-slate-300"}`}>{idx + 1}</div>
                            ...
                            >
                                <div className="max-w-[1280px] mx-auto px-6 md:px-12 space-y-16">
                                    ...
                                    <div className="max-w-2xl mx-auto text-center space-y-4">
                                        <div className="inline-flex items-center gap-2 bg-[#f97316]/10 text-[#f97316] border border-[#f97316]/20 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
                                            <span className="material-symbols-outlined text-sm select-none">diversity_3</span> Governance Crew
                                        </div>
                                        <h2 className="text-4xl font-black text-white tracking-tight">
                                            Meet Our <span className="bg-gradient-to-r from-[#8b5cf6] via-[#f97316] to-[#8b5cf6] bg-clip-text text-transparent">Tech Architects</span>
                                        </h2>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                                        {TEAM_MEMBERS.map((member, idx) => (
                                            <div
                                                ...
                                                className={`bg-white/5 border border-white/10 backdrop-blur-sm p-6 rounded-3xl transition-all duration-500 hover:-translate-y-2 hover:shadow-xl group flex flex-col items-center text-center cursor-pointer ${member.glow}`}
                                            >
                                                <div className="relative w-28 h-28 mb-5">
                                                    <div className="absolute inset-0 bg-gradient-to-tr from-[#8b5cf6] to-[#f97316] rounded-full group-hover:rotate-180 transition-transform duration-700"></div>
                                                    <img
                                                        src={member.image}
                                                        alt={member.name}
                                                ...
                                                <h4 className="font-black text-lg text-white group-hover:text-[#f97316] transition-colors duration-300">{member.name}</h4>
                                                <span className={`text-[10px] font-extrabold tracking-wider px-3 py-1 rounded-full uppercase mt-1.5 ${member.badge}`}>
                                                    {member.role}
                                                </span>

                                                <div className="w-12 h-[2px] bg-slate-800 my-4 group-hover:w-24 transition-all duration-500 bg-gradient-to-r from-[#8b5cf6] to-[#f97316]"></div>
                                                <p className="text-xs text-slate-300 font-medium leading-relaxed px-1 flex-1">{member.bio}</p>

                                                <div className="flex gap-4 mt-5 pt-3 border-t border-white/10 w-full justify-center text-slate-400 group-hover:text-[#f97316] transition-colors duration-300">
                ...
                {selectedMember && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
                        <div className="relative w-full max-w-lg bg-[#0d0c22] border border-white/10 rounded-3xl p-8 shadow-[0_0_50px_rgba(139,92,246,0.25)] text-center flex flex-col items-center">
                            {/* Close button */}
                            <button 
                            ...
                            <div className="relative w-32 h-32 mb-6">
                                <div className="absolute inset-0 bg-gradient-to-tr from-[#8b5cf6] to-[#f97316] rounded-full animate-pulse"></div>
                                <img
                                    src={selectedMember.image}
                                    alt={selectedMember.name}
                                    className="absolute inset-[4px] w-[120px] h-[120px] rounded-full object-cover border-2 border-[#0d0c22]"
                                />
                            </div>

                            {/* Info */}
                            <span className="bg-[#f97316]/10 text-[#f97316] border border-[#f97316]/20 text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full mb-3">
                                {selectedMember.role}
                            </span>
                            <h3 className="text-2xl font-black text-white">{selectedMember.name}</h3>
                            
                            <div className="w-16 h-[2px] bg-gradient-to-r from-[#8b5cf6] to-[#f97316] my-5"></div>
                            
                            <p className="text-sm text-slate-300 leading-relaxed mb-6 font-medium">
                                {selectedMember.bio}
                            </p>

                            <div className="bg-white/5 border border-white/5 rounded-2xl p-4 w-full text-left space-y-3">
                                <h4 className="text-xs font-black uppercase text-slate-400 tracking-widest">Platform Commitments</h4>
                                <div className="flex items-center gap-2 text-xs text-slate-200">
                                    <span className="material-symbols-outlined text-[#f97316] text-sm select-none">verified_user</span>
                                    <span>Verified LearnUp Core Contributor</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs text-slate-200">
                                    <span className="material-symbols-outlined text-[#8b5cf6] text-sm select-none">token</span>
                                    <span>Active Node Architect Authority</span>
                                </div>
                            </div>

                            <button 
                                onClick={() => setSelectedMember(null)}
                                className="mt-6 px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#8b5cf6] to-[#f97316] hover:brightness-110 text-white font-black text-xs shadow-md transition cursor-pointer"
                            >
                                Dismiss Profile
                            </button>
                        </div>
